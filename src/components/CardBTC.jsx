...
const CardBTC = () => {
    ...
    const fetchPrice = async () => {
      try {
        const responseDolar = await fetch('https://api.binance.com/api/v3/ticker/price?symbol=BTCUSDT');
        const responseReal = await fetch('https://api.binance.com/api/v3/ticker/price?symbol=BTCBRL');
    ...
    return (
      <StyledWrapper>
        <div className="card" onMouseEnter={fetchPrice}>
          <img className="img" src="https://upload.wikimedia.org/wikipedia/commons/4/46/Bitcoin.svg" alt="Bitcoin Logo" />
          <div className="textBox">
            <p className="text head">Bitcoin</p>
